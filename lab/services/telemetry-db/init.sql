...
VALUES
  ...
  ('telemetry.ops', md5('ops123'),   'TELEMETRY_OPS', 'SECRET',     'Dr. Radhika Nair',          'r.nair@orsu.space'),
  ('command.ops',  md5('ops123'),    'COMMAND_OPS',   'SECRET',     'Capt. Arjun Reddy',         'a.reddy@orsu.space'),
  ('payload.ops',  md5('ops123'),    'PAYLOAD_OPS',   'SECRET',     'Dr. Priya Sharma',          'p.sharma@orsu.space'),
  ('safety.ops',   md5('ops123'),    'SAFETY_OPS',    'TOP_SECRET', 'Cmdr. Vikram Bose',         'v.bose@orsu.space'),
